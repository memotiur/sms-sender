            ...
            <a href="#">
                <div class="widget-bg-color-icon card-box">
                    ...
                    <div class="text-right">
                        <h3 class="text-dark"><b class="counter">$ {{$result->account_balance}}</b></h3>
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
            <a href="/sell/list">
                <div class="widget-bg-color-icon card-box fadeInDown animated">
                    ...
                    <div class="text-right">
                        <h3 class="text-dark"><b class="counter">$ {{$total_price}}</b></h3>
                        <p class="text-muted mb-0">Today's SMS Price</p>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </a>
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
            <a href="/sell/list">
                <div class="widget-bg-color-icon card-box">
                    ...
                    <div class="text-right">
                        <h3 class="text-dark"><b class="counter">{{$sms_count}}</b></h3>
                        <p class="text-muted mb-0">Today SMS Count </p>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </a>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @foreach($sells as $sell)
                                        <tr>
                                            <td><a href="/sells/details/{{$sell->invoice}}"
                                                   class="text-dark"><b>{{$i++}}</b></a></td>
                                            ...
                                            <td><a href="/sells/details/{{$sell->invoice}}" class="text-dark"><p
                                                            class="text-danger">Show</p></a></td>
